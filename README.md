...
* [闲置域名竟被人举报涉黄！网信办称有截图为证](程序员日常/闲置域名竟被人举报涉黄！网信办称有截图为证.md)  
...
* [PHP魔术方法知识点整理](php/PHP魔术方法知识点整理.md)
* [PHP深入了解引用](php/PHP深入了解引用.md)  

* [常见排序算法及PHP实现](php/常见排序算法及PHP实现.md)  
...
* [MySQL基础知识点整理 - 事务、隔离级别、死锁](mysql/MySQL基础知识点整理%20-%20事务、隔离级别、死锁.md)
...
* [WEB页面实现等比例缩放自适应-通过rem和vw实现](前端/WEB页面实现等比例缩放自适应-通过rem和vw实现.md)

### [设计模式](设计模式/)

* [面向对象基本原则（1）- 单一职责原则与接口隔离原则](设计模式/面向对象基本原则（1）-&nbsp;单一职责原则与接口隔离原则.md) 
* [面向对象基本原则（2）- 里式代换原则与依赖倒置原则](设计模式/面向对象基本原则（2）-&nbsp;里式代换原则与依赖倒置原则.md) 
* [面向对象基本原则（3）- 最少知道原则与开闭原则](设计模式/面向对象基本原则（3）-&nbsp;最少知道原则与开闭原则)

### [网络](网络/)

* [OSI七层模型与TCP-IP五层模型简述](网络/OSI七层模型与TCP-IP五层模型简述.md) 
* [服务端面试宝典-HTTP协议知识点整理](网络/服务端面试宝典-HTTP协议知识点整理.md) 
